    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(currentView) === "input") {
        ...
        if (unref(parameterErrors).lookbackDays) {
          ...
          _push(`<p class="mt-1.5 text-xs text-muted-foreground"> Basis rata-rata dari ${ssrInterpolate(unref(parameters).lookbackDays || "?")} hari terakhir · min 7, maks 90 </p>`);
        }
...
//# sourceMappingURL=purchase-recommendations-Dbv_tR07.mjs.map
