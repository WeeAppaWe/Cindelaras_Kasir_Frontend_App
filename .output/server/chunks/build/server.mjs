import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, ref, watch, nextTick, computed, shallowRef, watchEffect, toValue, hasInjectionContext, inject, getCurrentScope, isRef, reactive, unref, toRefs, defineAsyncComponent, defineComponent, h, provide, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, effectScope, mergeProps, toRef, withCtx, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { w as withQuery, p as parseURL, l as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, k as joinURL, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, h as createError$1, x as executeAsync } from '../_/nitro.mjs';
...
const unhead_HuhwHDSs8D53D4Y130QhYJRk14Br7RnsLFhy5tIOF1g = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./purchase-recommendations-CwdfDILx.mjs')
  },
  {
  ...
  },
  {
    ...
    meta: { ...__nuxt_page_meta$b || {}, ...{ "middleware": "admin-only" } },
    component: () => import('./store-profile-CmXtVqwT.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-CxXW3u0P.mjs')
  },
  {
    name: "cashier",
    path: "/cashier",
...
const revive_payload_server_xa4DyfSaXJhChZu6jC3zsXOtzH6GN3j_58wRVQbfEgw = /* @__PURE__ */ defineNuxtPlugin({
...
const ssr_width_hHlXKglKZCyPkV1wdX9y7dzE_HMTlbfe2qoVkUmjDVM = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  provideSSRWidth(1024, nuxtApp.vueApp);
});
const plugins = [
  unhead_HuhwHDSs8D53D4Y130QhYJRk14Br7RnsLFhy5tIOF1g,
  plugin,
  revive_payload_server_xa4DyfSaXJhChZu6jC3zsXOtzH6GN3j_58wRVQbfEgw,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cm0ceViH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D4NcWpqO.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29_d8cc2ede725943892e76d87d49ac6c8c/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29_d8cc2ede725943892e76d87d49ac6c8c/node_modules/nuxt/dist/app/components/nuxt-root.vue");
