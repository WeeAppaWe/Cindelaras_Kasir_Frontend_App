...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex items-start justify-between gap-3"><div class="min-w-0"><h2 id="admin-popular-menu-title" class="text-base font-semibold tracking-normal"> Menu Terlaris </h2><p class="mt-1 text-sm text-muted-foreground"> Urutan berdasarkan jumlah terjual hari ini. </p></div></div>`);
      if (__props.items.length) {
...
//# sourceMappingURL=index-CxXW3u0P.mjs.map
