...
import { u as useAdminSemiIngredientApi, g as getAdminSemiIngredientValidationMessage, c as createAdminSemiIngredientProfilePayload, a as createAdminSemiIngredientBulkCompositionPayload, f as formatAdminSemiIngredientApiError } from './useAdminSemiIngredientApi-DwBnbisP.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(formError)) {
        _push(`<div class="whitespace-pre-line rounded-md border border-destructive/30 bg-destructive/5 px-3 py-2 text-sm text-destructive">${ssrInterpolate(unref(formError))}</div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/admin/app/pages/admin/semi-finished-ingredients/create.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=create-DDgPp4Tl.mjs.map
